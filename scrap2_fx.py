...
id_selector = 'a.css-901oao'
tweet_selector = '.r-1f6r7vd'
month = 'Feb'
...
for row in myresult:
    user = row[1]
    start = datetime.datetime(2020,2,16)  # year, month, day
    # end = datetime.datetime(2019,10,25)  # year, month, day
    ...
    for day in range(days):
	    ...
	    try:
	        ...
	        # found_tweets = driver.find_elements_by_partial_link_text('Feb')
	        # increment = 10
	        scroll = 6
